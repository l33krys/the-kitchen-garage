...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        item3 = Item(name="Espresso Machine", image="https://images.pexels.com/photos/10078423/pexels-photo-10078423.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", category="appliances", description="Brew coffee in seconds", inventory=15, price=99.00)
        item4 = Item(name="Toaster", image="https://images.pexels.com/photos/7936638/pexels-photo-7936638.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", category="appliances", description="Toast two slices of bread at once", inventory=3, price=39.00)
        # To use file images
